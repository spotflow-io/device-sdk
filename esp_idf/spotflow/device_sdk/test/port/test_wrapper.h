#ifndef SPOTFLOW_TEST_WRAPPER_H
#define SPOTFLOW_TEST_WRAPPER_H
...
#define TEST_SPOTFLOW_ASSERT_EQUAL_UINT8_ARRAY(exp, act, len) \
	TEST_ASSERT_EQUAL_UINT8_ARRAY((exp), (act), (len))
