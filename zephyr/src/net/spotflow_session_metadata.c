...
#define SPOTFLOW_NET_LOG_LEVEL CONFIG_SPOTFLOW_MODULE_DEFAULT_LOG_LEVEL
#else
#define SPOTFLOW_NET_LOG_LEVEL CONFIG_LOG_DEFAULT_LEVEL
#endif

LOG_MODULE_DECLARE(spotflow_net, SPOTFLOW_NET_LOG_LEVEL);
