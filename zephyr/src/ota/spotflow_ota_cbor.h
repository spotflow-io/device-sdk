...
/* Conservative worst-case sizing for a full v1 UPDATE_ARTIFACTS payload. */
#define SPOTFLOW_OTA_CBOR_MANIFEST_ENTRY_OVERHEAD 24
#define SPOTFLOW_OTA_CBOR_MANIFEST_ENTRY_SIZE                                                 \
	(SPOTFLOW_OTA_ARTIFACT_SLUG_MAX_LENGTH + SPOTFLOW_OTA_ARTIFACT_URL_MAX_LENGTH +       \
	 SPOTFLOW_OTA_ARTIFACT_SECRET_MAX_LENGTH + SPOTFLOW_OTA_ARTIFACT_VERSION_MAX_LENGTH + \
	 SPOTFLOW_OTA_CBOR_MANIFEST_ENTRY_OVERHEAD)
#define SPOTFLOW_OTA_CBOR_UPDATE_ARTIFACTS_FIXED_OVERHEAD 96
#define SPOTFLOW_OTA_CBOR_MAX_C2D_MESSAGE_SIZE               \
	(SPOTFLOW_OTA_CBOR_UPDATE_ARTIFACTS_FIXED_OVERHEAD + \
	 CONFIG_SPOTFLOW_OTA_MAX_ARTIFACTS * SPOTFLOW_OTA_CBOR_MANIFEST_ENTRY_SIZE)
