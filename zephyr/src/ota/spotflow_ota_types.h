...
enum spotflow_ota_attempt_error {
	...
	SPOTFLOW_OTA_ATTEMPT_ERROR_ARTIFACT_COUNT_EXCEEDED = 1,
	SPOTFLOW_OTA_ATTEMPT_ERROR_UNKNOWN_ARTIFACT_TYPE = 2,
	SPOTFLOW_OTA_ATTEMPT_ERROR_CANNOT_PARSE_MESSAGE = 3,
};
