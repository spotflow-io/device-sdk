...
def transform_board(board: Dict[str, Any], vendor: Dict[str, Any], 
                    spotflow_paths: Dict[str, str]) -> Dict[str, Any]:
    """
...
def generate_quickstart(boards_config: Dict[str, Any], 
                       spotflow_paths: Dict[str, str]) -> Dict[str, Any]:
